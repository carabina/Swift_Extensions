...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of Swift_Extensions.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/Swift_Extensions'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Morgan Berger' => 'morgan@Morgans-MacBook-Pro.local' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/Swift_Extensions.git', :tag => s.version.to_s }
